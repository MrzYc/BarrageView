...
@implementation ZYCDanmuBackView
...
- (NSMutableArray<id<ZYCDanmuModelDelegate>> *)danmuMs {
    if (!_danmuMs) {
...
- (void)check {
    ...
    [self.danmuMs sortUsingComparator:^NSComparisonResult(id<ZYCDanmuModelDelegate>  _Nonnull obj1, id<ZYCDanmuModelDelegate>  _Nonnull obj2) {
    ...
    for (id<ZYCDanmuModelDelegate> model in self.danmuMs) {
...
- (BOOL)checkBiuDanmuWithModel: (id<ZYCDanmuModelDelegate>)model index: (NSInteger)index {
